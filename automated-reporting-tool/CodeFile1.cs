...
namespace aptfullauto
{
    public class APTUpdate
    {
        public void RunAuto()
        {
            ...
            // Pulling SQL Data
            string connString = @"Data Source = 173.175.191.142;Initial Catalog=El_Paso_Video;User ID=reader;Password=reader;";
...
WHERE(Roster.[Agent Role] = 'Frontline' OR Roster.[Agent Role] = 'Lead') AND(Roster.[Status] = 'Active' OR Roster.[Status] = 'Leave of Absence')";
            ...
            connString = @"Data Source = 173.175.191.142;Initial Catalog=El_Paso_Video;User ID=reader;Password=reader;";
