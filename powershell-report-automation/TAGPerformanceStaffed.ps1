...
#cd '\\stxfile01.corp.twcable.com\RTXCareReporting\Report Main\Selenium\'
...
Copy-Item -Path '\\stxfile01.corp.twcable.com\RTXCareReporting\Report Main\Selenium\BIDownloader.ps1' -Destination $SelPath'BIDownloader.ps1' -Force
Copy-Item -Path '\\stxfile01.corp.twcable.com\RTXCareReporting\Report Main\Selenium\BIDownloaderDetails.ps1' -Destination $SelPath'BIDownloaderDetails.ps1' -Force
...
.\BIDownloader.ps1 "https://bi.corp.chartercom.com/MicroStrategy/servlet/mstrWeb?evt=4058&src=mstrWeb.4058&_subscriptionID=77B2B6655B4E11BB243784B37E28F69A&reportViewMode=1&Server=NCEPNBISMSA0001.CORP.CHARTERCOM.COM&Project=BI%20Reporting%20and%20Analytics&Port=34952&share=1" "StaffedTime" -saveFolderPath $SavPath
