...
ForEach($ele in $groups)
{
    ...
    if($ele.GetAttribute('innerText') -like "*VID*")
    {
		#031022: Intentionally skip any new hire cards for the PGP Analysis#
		if($ele.GetAttribute('innerText') -notlike "* NH*")
		{
